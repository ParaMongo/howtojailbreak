...
If you have never used Xcode, follow the below steps exactly. If you have sideloaded apps to your TV before, the process might have less steps. If you have already Paired your ATV to Xcode before, skip to _Step ***ENTER SOMETHING HERE***
...
Make sure that `Create Git repository on my Mac` is checked.
